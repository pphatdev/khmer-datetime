...
export class Constants {
    ...
    static readonly KH_NEW_YEAR_MOMENTS: Record<string, string> = {
    ...
    static readonly KHMER_NUMBERS: Record<string, string> = {
        '0': '០', '1': '១', '2': '២', '3': '៣', '4': '៤',
        '5': '៥', '6': '៦', '7': '៧', '8': '៨', '9': '៩'
    };

    static readonly ARABIC_NUMBERS: Record<string, string> = {
        '០': '0', '១': '1', '២': '2', '៣': '3', '៤': '4',
        '៥': '5', '៦': '6', '៧': '7', '៨': '8', '៩': '9'
    };
}
