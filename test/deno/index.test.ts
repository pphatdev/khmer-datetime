...
describe('FormatDateTime', () => {
    ...
    it('should format lunar date correctly via KhmerDate presets', () => {
        ...
        expect(kd.toLunarDate('full')).toBe('ថ្ងៃព្រហស្បតិ៍ ២កើត ខែទុតិយាសាឍ ឆ្នាំមមី អដ្ឋស័ក ពុទ្ធសករាជ ២៥៧០');
        expect(kd.toLunarDate('short')).toBe('២កើត ខែទុតិយាសាឍ');
        expect(kd.toLunarDate('medium')).toBe('២កើត ខែទុតិយាសាឍ ព.ស. ២៥៧០');
    });
